...
bool vbn_ros_msgs__msg__gps2_raw__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("vbn_ros_msgs.msg._gps2_raw.GPS2Raw", full_classname_dest, 34) == 0);
  }
  vbn_ros_msgs__msg__GPS2Raw * ros_message = _ros_message;
  {  // header
...
{
  /* NOTE(esteve): Call constructor of GPS2Raw */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("vbn_ros_msgs.msg._gps2_raw");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "GPS2Raw");
