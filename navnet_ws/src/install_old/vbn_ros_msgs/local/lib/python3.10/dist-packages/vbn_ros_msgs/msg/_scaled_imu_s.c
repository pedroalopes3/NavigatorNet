...
bool vbn_ros_msgs__msg__scaled_imu__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("vbn_ros_msgs.msg._scaled_imu.ScaledIMU", full_classname_dest, 38) == 0);
  }
  vbn_ros_msgs__msg__ScaledIMU * ros_message = _ros_message;
  {  // header
  ...
  {  // time_boot_ms
    ...
    ros_message->time_boot_ms = PyLong_AsUnsignedLongLong(field);
    Py_DECREF(field);
  }
  {  // xacc
...
{
  /* NOTE(esteve): Call constructor of ScaledIMU */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("vbn_ros_msgs.msg._scaled_imu");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "ScaledIMU");
  ...
  {  // time_boot_ms
    PyObject * field = NULL;
    field = PyLong_FromUnsignedLongLong(ros_message->time_boot_ms);
    {
