...
class Metaclass_ScaledIMU(type):
    """Metaclass of message 'ScaledIMU'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            logger = logging.getLogger(
                'vbn_ros_msgs.msg.ScaledIMU')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__msg__scaled_imu
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__msg__scaled_imu
            cls._CONVERT_TO_PY = module.convert_to_py_msg__msg__scaled_imu
            cls._TYPE_SUPPORT = module.type_support_msg__msg__scaled_imu
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__msg__scaled_imu
...
class ScaledIMU(metaclass=Metaclass_ScaledIMU):
    """Message class 'ScaledIMU'."""
    ...
    def time_boot_ms(self, value):
        if __debug__:
            ...
            assert value >= 0 and value < 18446744073709551616, \
                "The 'time_boot_ms' field must be an unsigned integer in [0, 18446744073709551615]"
