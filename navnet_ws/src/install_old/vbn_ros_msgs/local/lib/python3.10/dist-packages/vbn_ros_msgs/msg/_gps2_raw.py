...
class Metaclass_GPS2Raw(type):
    """Metaclass of message 'GPS2Raw'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            logger = logging.getLogger(
                'vbn_ros_msgs.msg.GPS2Raw')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__msg__gps2_raw
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__msg__gps2_raw
            cls._CONVERT_TO_PY = module.convert_to_py_msg__msg__gps2_raw
            cls._TYPE_SUPPORT = module.type_support_msg__msg__gps2_raw
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__msg__gps2_raw
    ...
    def GPS_FIX_TYPE_NO_GPS(self):
        ...
        return Metaclass_GPS2Raw.__constants['GPS_FIX_TYPE_NO_GPS']

    @property
    def GPS_FIX_TYPE_NO_FIX(self):
        """Message constant 'GPS_FIX_TYPE_NO_FIX'."""
        return Metaclass_GPS2Raw.__constants['GPS_FIX_TYPE_NO_FIX']

    @property
    def GPS_FIX_TYPE_2D_FIX(self):
        """Message constant 'GPS_FIX_TYPE_2D_FIX'."""
        return Metaclass_GPS2Raw.__constants['GPS_FIX_TYPE_2D_FIX']

    @property
    def GPS_FIX_TYPE_3D_FIX(self):
        """Message constant 'GPS_FIX_TYPE_3D_FIX'."""
        return Metaclass_GPS2Raw.__constants['GPS_FIX_TYPE_3D_FIX']

    @property
    def GPS_FIX_TYPE_DGPS(self):
        """Message constant 'GPS_FIX_TYPE_DGPS'."""
        return Metaclass_GPS2Raw.__constants['GPS_FIX_TYPE_DGPS']

    @property
    def GPS_FIX_TYPE_RTK_FLOAT(self):
        """Message constant 'GPS_FIX_TYPE_RTK_FLOAT'."""
        return Metaclass_GPS2Raw.__constants['GPS_FIX_TYPE_RTK_FLOAT']

    @property
    def GPS_FIX_TYPE_RTK_FIXED(self):
        """Message constant 'GPS_FIX_TYPE_RTK_FIXED'."""
        return Metaclass_GPS2Raw.__constants['GPS_FIX_TYPE_RTK_FIXED']

    @property
    def GPS_FIX_TYPE_STATIC(self):
        """Message constant 'GPS_FIX_TYPE_STATIC'."""
        return Metaclass_GPS2Raw.__constants['GPS_FIX_TYPE_STATIC']

    @property
    def GPS_FIX_TYPE_PPP(self):
        """Message constant 'GPS_FIX_TYPE_PPP'."""
        return Metaclass_GPS2Raw.__constants['GPS_FIX_TYPE_PPP']


class GPS2Raw(metaclass=Metaclass_GPS2Raw):
    """
    Message class 'GPS2Raw'.
