...
bool vbn_ros_msgs__msg__gps_raw_int__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("vbn_ros_msgs.msg._gps_raw_int.GPSRawInt", full_classname_dest, 39) == 0);
  }
  vbn_ros_msgs__msg__GPSRawInt * ros_message = _ros_message;
  {  // header
  ...
  {  // hdg_acc
    ...
    assert(PyLong_Check(field));
    ros_message->hdg_acc = PyLong_AsUnsignedLong(field);
    Py_DECREF(field);
  }
  {  // yaw
...
{
  /* NOTE(esteve): Call constructor of GPSRawInt */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("vbn_ros_msgs.msg._gps_raw_int");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "GPSRawInt");
  ...
  {  // hdg_acc
    PyObject * field = NULL;
    field = PyLong_FromUnsignedLong(ros_message->hdg_acc);
    {
