...
bool vbn_ros_msgs__msg__wind__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("vbn_ros_msgs.msg._wind.Wind", full_classname_dest, 27) == 0);
  }
  vbn_ros_msgs__msg__Wind * ros_message = _ros_message;
  {  // header
  ...
  {  // speed_z
    ...
    assert(PyFloat_Check(field));
    ros_message->speed_z = (float)PyFloat_AS_DOUBLE(field);
    Py_DECREF(field);
  }
...
PyObject * vbn_ros_msgs__msg__wind__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("vbn_ros_msgs.msg._wind");
